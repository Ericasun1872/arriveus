...
export const categoryFaqs: Record<string, FaqItem[]> = {
  ...
  dmv: [
    ...
    },
    {
      ...
      answer:
        "사고·현장은 ‘교통사고·단속·티켓’, 우편 벌금·납부·점수·첫 위반 유예는 ‘교통 티켓·벌금·운전 점수’ 가이드를 참고하세요.",
    },
    {
      question: "과속 티켓이 집으로 왔어요.",
      answer:
  ...
  immigration: [
    ...
    {
      question: "영주권이 없어도 직장 비자로 오래 근무해도 되나요?",
      answer:
        "가능합니다. H-1B·L-1처럼 회사 스폰서로 받는 취업 비자는 ‘그 일을 하려고 정해진 기간만 머무는’ 임시 체류이고, 영주권(그린카드)과는 다른 신분입니다. 비자·연장·이직은 ArriveUS ‘직장 비자·장기체류’ 가이드를 보세요. 전화·은행·운전면허 같은 생활 정착은 신분과 별개이니 ‘도착 첫 7일’과 주별 DMV 가이드를 보면 됩니다.",
    },
    {
  ...
  job: [
    {
      ...
      answer:
        "많은 분들이 식당·네일·창고·돌봄·청소·한인 업장에서 먼저 시작합니다. 오피스로 넘어갈 때는 ArriveUS ‘오피스·LinkedIn 구직’·이력서 가이드를, 현장은 ‘식당·네일·창고…’ 가이드를 보세요.",
    },
    {
      question: "합법적으로 일할 수 있는지 어떻게 확인하나요?",
      answer:
        "시민·영주권·EAD·비자·OPT 등 본인 서류와 I-9 허용 목록을 확인하세요. ArriveUS ‘신분·EAD별 합법 근로’ 가이드를 참고하세요. ITIN만으로는 부족합니다.",
    },
    {
      question: "직장에서 차별·성희롱을 당하면요?",
      answer:
        "날짜·증거를 남기고 EEOC 또는 (I-9·이민 신분 차별이면) DOJ IER 안내를 확인하세요. ArriveUS ‘직장 차별·괴롭힘 신고’ 가이드를 참고하세요.",
    },
    {
  ...
  housing: [
    ...
    },
    {
      ...
      answer:
        "신용 확인 → 세금·W-2 → 은행 명세서 → Pay stub → Pre-approval 순으로 서류를 모은 뒤 매물을 보는 경우가 많습니다. ArriveUS ‘집 구입·모기지 기초’·‘첫 주택 구매 지원’ 가이드를 참고하세요.",
    },
    {
    ...
    {
      question: "모기지에 세금·월급 명세서가 왜 필요해요?",
      answer:
        "렌더가 소득·자산·신용을 확인하기 위해서입니다. 보통 최근 세금 신고·W-2, 은행 명세서, Pay stub를 요청합니다. 목록은 렌더마다 다릅니다.",
    },
    {
