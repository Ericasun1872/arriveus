...
export const categoryFaqs: Record<string, FaqItem[]> = {
  ...
  dmv: [
    ...
    },
    {
      ...
      answer:
        "주·체류 목적에 따라 다릅니다. 워싱턴(시애틀)에서는 관광 등 방문이면 해외 면허로 일정 기간 운전이 가능할 수 있고, 거주자가 되면 보통 30일 안에 주 면허가 필요합니다. 유효한 한국 면허(18세+)는 WA에서 필기·도로 시험 면제로 주 면허 교체가 가능한 경우가 많습니다. 자세한 내용은 ‘타주·해외 면허 이전’ 가이드와 dol.wa.gov를 확인하세요.",
    },
    {
      question: "시애틀에서 한국 면허를 워싱턴 면허로 바꿀 수 있나요?",
      answer:
        "네. Washington DOL 공식 ‘Do I need to take a test?’ 안내에서 South Korea는 유효 면허·18세 이상이면 knowledge/drive test 면제 대상입니다. 시력 검사·서류·수수료는 필요하며, 예약 전 최신 공지를 확인하세요.",
    },
    {
