...
export const dmvGuides: Guide[] = [
  ...
  },
  {
    ...
    title: "운전면허 신규 발급",
    summary:
      "미국에서 처음 운전면허를 받을 때 필요한 서류와 시험(필기·실기) 흐름을 안내합니다.",
    cost: "주마다 상이",
    methods: ["방문"],
    overview:
      "신규 면허는 보통 필기시험, 시력 검사, 도로주행 시험을 거쳐 발급됩니다. 국제운전면허증만으로는 장기 거주 시 충분하지 않은 경우가 많습니다. 거주 신분에 따라 제출 서류가 달라지므로 미리 체크리스트를 준비하세요.",
    requirements: [
      "신원 확인 서류 (여권, 비자/영주권 등)",
      "거주지 증명",
      "SSN 또는 관련 서류",
      "필기·실기 시험 준비",
    ],
    steps: [
      "거주 주 DMV에서 신규 면허 요건을 확인합니다.",
      "필기시험을 예약하고 합격합니다.",
      "필요한 경우 Learner Permit으로 연습을 합니다.",
      "도로주행 시험을 예약하고 응시합니다.",
      "합격 후 수수료를 납부하고 면허를 수령합니다.",
    ],
    links: [
      {
        label: "USA.gov – Drivers Licenses",
  ...
  },
  {
    ...
    title: "주소 변경",
    summary:
      "이사 후 운전면허와 차량 등록 주소를 바꾸는 일반적인 절차와 준비물입니다.",
    cost: "무료–소액 수수료 (주마다 상이)",
    methods: ["온라인", "우편", "방문"],
    overview:
      "이사를 하면 대부분의 주에서 일정 기간 안에 DMV에 주소 변경을 신고해야 합니다. 면허증 주소와 차량 등록 주소를 함께 업데이트하는 경우가 많고, 투표인 등록·보험사 주소 변경도 같이 챙기는 것이 좋습니다. 기한을 놓치면 벌금이나 갱신 시 문제가 생길 수 있으니 거주 주 규정을 확인하세요.",
    requirements: [
      "현재 운전면허증 또는 주 발급 ID",
      "새 거주지 증명 (임대 계약서, 공과금 고지서 등)",
      "차량 등록증 (차량이 있는 경우)",
    ...
    steps: [
      "거주 주 DMV에서 주소 변경 기한과 방법을 확인합니다.",
      "온라인으로 가능한지 보고, 불가하면 우편·방문을 준비합니다.",
      "운전면허/ID 주소를 새 주소로 업데이트합니다.",
      "차량이 있으면 등록 주소도 함께 변경합니다.",
      "보험사·은행·USPS(우편 전달)에도 새 주소를 등록합니다.",
    ],
    links: [
      {
