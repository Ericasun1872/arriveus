...
export const immigrationGuides: Guide[] = [
  ...
  },
  {
    ...
    overview:
      "N-400은 영주권자(일부 예외 포함)가 미국 시민이 되기 위해 제출하는 귀화 신청서입니다. 일반적으로 일정 기간의 영주권 유지·미국 내 거주(Physical presence)·연속 거주(Continuous residence)·도덕성·영어·시민 지식 시험 등이 요건에 포함되며, 세부 자격은 나이·장애 면제·군인·시민 배우자 등 예외가 많습니다.\n\n큰 흐름은 자격 자가점검 → 여행·세금·주소·형사 기록 정리 → N-400 제출 → 바이오메트릭스 → 인터뷰·시험 → 승인 → 선서식(Oath) → 시민권증 → SSA·여권 등 후속입니다. 긴 해외 체류·미납 세금·미기재 체포 이력은 인터뷰에서 문제로 불거지는 경우가 많아, 제출 전 달력·여권 출입국·세금 사본을 맞춰 보는 것이 안전합니다.\n\n시민권을 받으면 SSN 숫자는 그대로인 경우가 많지만 SSA에 시민권 취득을 알려 기록을 갱신하는 것이 좋습니다. N-400에서 SSA 업데이트를 함께 요청할 수 있는 경우도 있습니다. 이 가이드는 개요일 뿐이며, 자격 판정·면제·복잡한 이력은 변호사 검토가 필요한 경우가 많습니다.",
    requirements: [
      "영주권 카드(및 조건부 영주권이면 I-751 등 관련 이력)",
      "거주·출국 여행 기록 (날짜·기간 메모, 여권 전체)",
      "세금 신고·선택적 서비스(해당 시) 등 신청서 문항 관련 정보",
      "영어·시민 시험 준비 자료 (면제·완화 해당 여부 확인)",
      "주소·혼인·자녀·이름 변경 증빙",
      "수수료 결제 수단 (온라인/종이 제출 방식에 따름)",
    ],
    steps: [
      "uscis.gov/n-400과 Citizenship 안내에서 최신 자격·수수료·Edition·면제 규정을 확인합니다.",
      "지난 해당 기간의 해외 여행 일수·주소·직장·혼인·자녀를 표로 정리합니다.",
      "세금·형사 관련 질문을 숨기지 않고 준비합니다. 애매하면 제출 전 변호사와 검토합니다.",
      "N-400을 작성·제출하고 Receipt·바이오·인터뷰 Notice를 myUSCIS로 추적합니다.",
      "인터뷰에서 영어·시민 시험을 보고, 결과에 따라 재시험·추가 서류가 있을 수 있습니다.",
      "승인 후 선서식에 참석해 시민이 되고 시민권증을 보관합니다. SSA·미국 여권·주소 변경을 이어서 처리합니다.",
    ],
    links: [
      {
        label: "USCIS – N-400",
    ...
    faq: [
      ...
      {
        question: "신청 중 해외여행을 해도 되나요?",
        answer:
          "긴 출국은 Continuous residence에 영향을 줄 수 있습니다. 여행 전 USCIS 안내·변호사와 확인하세요.",
      },
      {
        question: "인터뷰에서 떨어지면요?",
        answer:
          "재시험·추가 서류·거부 후 재신청 등 경로가 있을 수 있습니다. Notice 내용과 기한을 읽고 필요하면 변호사를 찾으세요.",
      },
    ],
    updatedAt: "2026-09",
    disclaimer,
  },
  {
    ...
    title: "취업 이민(EB-3) 개요",
    summary:
      "고용주 스폰서 영주권(특히 EB-3)의 큰 흐름과, 회사가 하는 일·직원이 확인할 일 체크리스트, 사기 주의사항을 정리했습니다.",
    ...
    steps: [
      ...
      "회사·변호사 측: 직무기술서와 임금을 확정하고, PERM에 필요한 채용광고·미국 노동자 채용 시도·관련 기록을 준비합니다(세부 요건은 DOL·변호사 안내).",
      "고용주 측에서 보통 PERM(노동인증)을 제출합니다. 승인되어야 다음 단계로 가기 쉬운 경우가 많습니다.",
      "PERM 이후 고용주가 Form I-140(이민 청원)을 USCIS에 제출합니다. 승인되면 우선순위 날짜(Priority Date)가 생깁니다. 직원은 Receipt·승인 통지 사본을 받아 둡니다.",
    ...
    faq: [
      ...
      {
        question: "회사가 보통 무엇을 하나요?",
        answer:
          "풀타임 직무·임금·근무지를 정하고, 변호사와 PERM(채용광고·미국 노동자 채용 시도 등)·I-140을 진행하는 경우가 많습니다. ability to pay·기록 보관도 고용주 쪽 이슈인 경우가 많습니다. 세부 의무는 변호사·DOL·USCIS 안내를 확인하세요.",
      },
      {
        question: "직원은 무엇을 확인하면 되나요?",
        answer:
          "오퍼의 직무·급여·스폰서 여부, 누가 PERM/I-140을 넣고 비용을 내는지, 변호사 연락처, Priority Date·Visa Bulletin, 이직 시 영향을 서면·변호사와 확인하세요. ‘보장·선입금’ 광고는 거절하세요.",
      },
      {
    ...
    disclaimer:
      "ArriveUS 가이드는 일반적인 참고 정보이며 이민·법률·채용 알선 자문이 아닙니다. 특정 회사·공장·에이전시를 추천하거나 영주권 승인을 보장하지 않습니다. 회사 실무·수수료·채용광고 요건의 최종 판단은 고용주와 자격 있는 이민 변호사의 몫입니다. 자격·수수료·대기·전략은 수시로 바뀌므로 USCIS·DOL·국무부 공식 안내와 Accredited Representative를 확인하세요.",
  },
  {
    slug: "ead-renewal",
    category: "immigration",
  ...
  },
  {
    ...
    overview:
      "가족 기반 영주권은 미국 시민 또는 영주권자가 자격 있는 가족을 위해 청원(흔히 Form I-130)을 넣는 구조가 일반적입니다. 배우자·미성년 자녀·부모 등 ‘즉시 친족(Immediate relative)’은 대기 없이 다음 단계로 가는 경우가 많고, 성인 자녀·형제처럼 Preference 카테고리는 Visa Bulletin 대기가 길 수 있습니다. 스폰서가 시민인지 영주권자인지에 따라 가능한 가족 범위도 달라집니다.\n\nI-130 승인 후에도 끝이 아닙니다. 의료검사, 재정 보증(Affidavit of Support, 예: I-864), 인터뷰, 미국 내 신분조정(I-485) 또는 해외 영사관 이민 비자 수속이 이어질 수 있고, 진행 중 EAD·여행 허가(Advance Parole)가 따로 필요한 경우도 있습니다. 조건부 영주권(결혼 2년 미만 등)이면 이후 I-751 조건 제거가 따라올 수 있습니다.\n\n‘결혼만 하면 바로 카드’, ‘서류 대행 보증’, 선입금만 요구하는 중매·대행은 사기·형사 위험이 큽니다. 이 글은 용어와 순서만 잡는 개요이며, 자격·동시 제출·근로·여행은 변호사·USCIS 공식 안내로 확인하세요.",
    requirements: [
      "스폰서의 시민권·영주권 증빙과 관계 증명(혼인·출생 등)",
      "초청·피초청자 여권·입국·체류 기록",
      "재정 보증(예: I-864) 가능 여부·소득 증빙 검토",
      "실제 관계 증거(공동 주소·금융·사진 등, 해당 시)",
      "의료검사·예방접종 기록(다음 단계 안내 시)",
    ],
    steps: [
      "가족 관계가 즉시 친족인지 Preference인지, 스폰서 신분으로 가능한지 USCIS Family 안내로 확인합니다.",
      "스폰서가 I-130 등 청원 자격·증거 목록·수수료를 공식 지시서에서 확인합니다.",
      "접수 후 Receipt·바이오·RFE를 myUSCIS로 관리하고, 주소 변경을 즉시 반영합니다.",
      "대기 카테고리면 Visa Bulletin을 주기적으로 보고, 날짜가 열리면 I-485 또는 영사 수속 안내를 따릅니다.",
      "의료검사·재정 보증·인터뷰를 기한에 맞춰 준비하고, 허위 서류·위장 결혼 요구는 거절합니다.",
      "승인 후 카드 수령·SSN·EAD(해당 시)·주소 변경을 정리하고, 조건부면 I-751 일정을 캘린더에 넣습니다.",
    ],
    links: [
      {
  ...
  },
  {
    ...
    overview:
      "F-1은 학업을 위한 학생 신분으로, 풀타임 등록·출석·학교 SEVIS 기록 유지가 핵심입니다. 교내 근로, 현장실습 CPT, 졸업 후 실무훈련 OPT(및 STEM OPT 연장)는 각각 허가 주체와 시점이 다릅니다. CPT/OPT는 보통 학교 DSO 승인·SEVIS 업데이트와 USCIS(예: OPT용 I-765)가 겹칩니다.\n\n큰 그림을 놓치기 쉬운 지점: (1) 허가 없이 일하면 신분 위반 위험이 큼 (2) OPT 실업 일수·보고 의무 (3) 여행 시 I-20 여행 서명·비자 스탬프 (4) ‘OPT=영주권’이 아님. STEM OPT·Cap-gap 등 세부 규칙은 바뀌므로 Study in the States·학교 안내를 우선하세요. ArriveUS는 입학 알선·불법 근로를 안내하지 않습니다.",
    requirements: [
      "유효 I-20·여권·I-94·비자 스탬프",
      "학교 DSO·국제학생 사무실 연락처",
      "등록·성적·전공 기록",
      "OPT 시 졸업일·고용주·직무가 전공과 관련되는지 설명 자료",
    ],
    steps: [
      "입학·전학·휴학·온라인 수업 비율 변경 전 DSO에게 신분 유지 요건을 확인합니다.",
      "교내·CPT·OPT 근로가 필요하면 DSO와 먼저 상의하고, 허가·SEVIS 업데이트 전에 일하지 않습니다.",
      "OPT 일정이 되면 학교 추천·SEVIS 업데이트 후 I-765 마감·수수료·사진 요건을 USCIS에서 확인합니다.",
      "EAD를 받으면 만료일·실업 일수·주소·고용 보고를 Study in the States·학교 안내에 따라 지킵니다.",
      "STEM OPT·Cap-gap·신분 변경(H-1B 등)은 별도 규칙이므로 조기 상담합니다.",
      "여행·졸업 후 계획은 카톡 소문보다 I-20·DSO·변호사 문서를 따릅니다.",
    ],
    links: [
      {
    ...
    faq: [
      ...
      {
        question: "CPT와 OPT 차이는요?",
        answer:
          "CPT는 보통 재학 중 학교 승인 실습, OPT는 졸업 전후 실무훈련으로 USCIS EAD가 따르는 경우가 많습니다. 학교 규정이 우선입니다.",
      },
      {
        question: "OPT만 있으면 영주권이 되나요?",
        answer:
          "아니요. OPT는 임시 실무훈련입니다. 취업 이민·다른 비자는 별도 절차입니다.",
      },
    ],
    updatedAt: "2026-09",
    disclaimer,
